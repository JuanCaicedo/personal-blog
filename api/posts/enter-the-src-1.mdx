...
el código usando esas herramientas, podremos entenderlo de un modo más intuitivo.

## Siguientes pasos
Ahorita no mucho del VR ni tampoco de como visualizar codigo. Ese es mi reto
