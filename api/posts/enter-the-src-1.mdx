...
de lanzarle flechas a unos hombresitos que vienen a atacar un castillo. El juego
...
También me impresionó como el juego usaba el instinto natural del vertigo. El
...
pueden significar. El VR nos da una oportunidad la oportunidad de crear
visualizaciones que aprovechan otros aspectos de la percepción. Si representamos
el codigo usando esas herramientas, podremos entenderlo de un modo más intuitivo.

## Siguentes pasos
Ahorita no mucho del VR ni tampoco de como visualizar codigo. Ese es mi reto durante los próximos
dos meses antes de la RubyConf, aprender de esos temas y formar algun prototipo.
Si les interesa, por aquí estaré poniendo más detalles!
