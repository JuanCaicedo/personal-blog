...
### July 12, 2020
- Move garden from `/garden` to `/`
- Move remaning pages into the garden
- Reroute `/garden/<path>` to `<path>`

### July 3, 2020
- Took a two week break from writing here 😅
- Move tools page to garden

### June 17, 2020
- Start series about [[conference talks revisited]]

### June 15, 2020
- Added some thoughts abouts [[refactoring]]

### June 14, 2020
- Woopsie, didn't do any gardening

### June 13, 2020
- Update [[gatsby-theme-brain]] to ignore [[spacemacs]] autosave files

### June 12, 2020
- Added some thoughts on [[Jose Browne]]'s article on [[ego and programming]]

### June 11th, 2020
- Add some notes about [[empathizing with your users]]
