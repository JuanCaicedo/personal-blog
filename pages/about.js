...
const AboutMe = () => (
  <div>
    ...
    <div>
      ...
      between Bogota and Portland, Oregon. This made me fascinated with how
    ...
    <div>
      ...
      CuriosityMedia on <a href="http://www.spanishdict.com/">SpanishDict.com</a>{' '}
      first in the city and afterwards remotely.
    </div>
    <div>
      ...
      Washington DC I helped establish{' '}
      <a href="https://nodeschool.io/washingtondc/">NodeSchool DC</a> and was an
      organizer for <a href="https://www.meetup.com/node-dc/">NodeDC</a>. I also
      give talks an workshops all over the world to help others learn various
      javascript topics.
    </div>
  </div>
)
...
const Blog = () => (
  <div>
    ...
    <div>
      ...
      <a href="https://medium.com/@_juancaicedo">Medium</a>) about my interests in
      javascript, emacs, and programming.
    </div>
  </div>
)
    ...
    <ul>
      <li>
        ...
        <ul>
          ...
          <li>
            Forward Courses (
            <a href="https://forwardcourses.com/workshops/119">online workshop</a>)
          </li>
        </ul>
      </li>
      <li>
